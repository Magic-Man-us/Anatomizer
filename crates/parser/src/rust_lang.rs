...
impl LanguageParser for RustParser {
    ...
    fn extract_functions(_tree: &Tree, _code: &str) -> Vec<FunctionDef> {
        // TODO: Walk AST for `function_item` nodes
        vec![]
    }

    fn extract_loops(_tree: &Tree, _code: &str) -> Vec<LoopConstruct> {
        // TODO: Walk AST for `for_expression`, `while_expression`, `loop_expression`
        vec![]
    }
    ...
    fn extract_concurrency(
        ...
        // TODO: Detect Mutex, RwLock, Arc, thread::spawn, tokio::spawn
        (vec![], vec![], vec![])
    }

    fn extract_allocations(_tree: &Tree, _code: &str) -> Vec<AllocationSite> {
        // TODO: Detect Box::new, Vec::new, String::from (heap) vs let bindings (stack)
        vec![]
    }
}
